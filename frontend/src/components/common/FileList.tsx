...
interface FileListProps {
  files?: FileItem[];
  onDelete?: ((fileId: string) => void) | null;
  showDelete?: boolean;
}

type FileIconType = 'image' | 'video' | 'audio' | 'pdf' | 'archive' | 'document';
...
const FileList: React.FC<FileListProps> = ({
  ...
  const getFileIcon = (mimeType?: string): FileIconType => {
  ...
  const getFileIconSVG = (type: FileIconType) => {
